...
__all__ = ['full_file', 'full_num', 'full_num_names_file', 'create_file', 'new_gen_files', ]
...
_VOWELS = "JHHGF"
_CONSONANTS = "GHGJHLJJPOPIOIOPKJ"
_MIN_LEN = 4
_MAX_LEN = 7
...
def full_file_num(file_name: str, str_count: int):
    ...
    with open(file_name, "a", encoding="UTF-8") as f:
        for _ in range(str_count):
            number_1 = rnd.randint(_MIN_VAL, _MAX_VAL)
            number_2 = rnd.uniform(_MIN_VAL, _MAX_VAL)
...
def full_file_name(file_name: str, name_count: int):
...
def full_num_names_file(num_file: str, name_file: str, destination: str):
...
if __name__ == "__main__":
    full_file_num("number.txt", 10)
    full_file_name("names_file.txt", 10)
    full_num_names_file("number.txt", "names_file.txt", "new_file.txt")
